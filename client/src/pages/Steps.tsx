...
function Steps() {
  ...
  useEffect(() => {
    ...
    const selector =
      `[data-notification-ref="step-${notificationReferenceId}"]`;
              ...
              {pendingSteps.length >
                ...
                <div className="steps-section">
                  <h2 className="section-title">
                    Étapes en attente du vote des membres (
                    {
                      pendingSteps.length
                    }
                    )
                  ...
                  <p className="section-subtitle">
                    ...
                    <br />
                    Pour valider une étape, tous les membres doivent avoir voté, avec une majorité de OUI.
                  </p>
